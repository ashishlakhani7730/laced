                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> Unshipped Item
                        </h4>
                    </div>
                </div>
            </div>
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                if (json.code == 1)
                {
                    ...
                    {
                        htmls += "<tr><td><strong>Auction Starting date - </strong></td><td>" + json.data[0].Item_Sale_StartDate + "</td></tr>";
                    }
                    ...
                    {
                        htmls += "<tr><td><strong>Auction Ending date - </strong></td><td>" + json.data[0].Item_Sale_EndDate + "</td></tr>";
                    }
                    htmls += "<table>";
                    htmls += "</div></div>";
