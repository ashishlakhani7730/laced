				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">Fees Policy</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li class="active"><span>Fees Policy</span></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Fees Policy</h6>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<form name="appworks" method="post" action="<?php echo site_url("fpolicy/addfpolicy"); ?>">
										  <div class="form-group">
											<textarea class="textarea_editor form-control" name="texteditor" rows="15" placeholder="Enter text ..." required="required"><?php if($fpolicy['fpolicy'] != ''){ echo $fpolicy['fpolicy']; } ?></textarea>
											<input type="hidden" name="exitsornot" value="<?php if($fpolicy['fpolicy'] == ''){ echo 0; }else{ echo 1;} ?>">
										  </div>
...
<script>
	...
	<?php } ?>
	<?php if(empty($this->session->flashdata('message_fpolicy'))) { ?>
			$('#successMessage').hide();
	<?php } else { ?>
			setTimeout(function() {
	...
	<?php if(empty($this->session->flashdata('message_fail_fpolicy'))) { ?>
			$('#failMessage').hide();
	<?php } else { ?>
			setTimeout(function() {
