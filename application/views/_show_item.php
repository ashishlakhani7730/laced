                    ...
                    <div class="row heading-bg">
                        ...
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <ol class="breadcrumb">
                                ...
                                <li><a href="#"><span>All Product List</span></a></li>
                            </ol>
                        </div>
                        <!-- /Breadcrumb -->
                    </div>
                                                ...
                                                echo $Date ?></td>
                                                        ...
                                                        <td><div class="input-group-btn">
                                                                ...
                                                                <ul class="dropdown-menu">                                 
                                                                    ...
                                                                    if ($item->Item_Status == '1') {
                                                                        ?>
                                                                        <li><a href="<?php echo site_url("item/app_disapp/$item->Item_Id/$item->User_Id/0/allitem") ?>"><span class="glyphicon glyphicon-remove" style="color: red"> </span>&nbsp; disapproved</a></li>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                    <?php
                                                                    if ($item->Item_Status == '0') {
                                                                        ?>
                                                                        <li><a href="<?php echo site_url("item/app_disapp/$item->Item_Id/$item->User_Id/1/allitem") ?>"><span class="glyphicon glyphicon-ok" style="color: green"> </span>&nbsp; approve</a></li>
                                                                        <?php
                                                                    }
                                                                    ?>

                                                                    <li><?php if ($item->Item_Status == '0') { ?><a  href="<?php echo site_url("item/raffle_data/$item->Item_Id/allitem") ?>"> <span class="pe pe-7s-ticket" ></span>   &nbsp;   Raffle</a><?php
                                                                        } else {
                                                                            
                                                                        }
                                                                        ?> </li>
                                                                    <li><?php if ($item->Item_Status == '0') { ?><a  href="<?php echo site_url("item/contest_data/$item->Item_Id/allitem") ?>"> <span class="pe pe-7s-ticket" ></span>   &nbsp;  Contest</a><?php
                                                                        } else {
