                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> Raffle Date
                        </h4>
                    </div>
                </div>
            </div>
							...
							<div id="modfailMessage" class="alert alert-info alert-dismissable">
							 ...
							 <form>
                                                            <div class="form-group">
                                                                <label class="control-label mb-10 text-left">Raffle Strat Date</label>
															...
															<div class="form-group">
                                                                <label class="control-label mb-10 text-left">Raffle Strat Time</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label mb-10 text-left">Raffle End Date</label>
															...
															<div class="form-group">
                                                                <label class="control-label mb-10 text-left">Raffle End Time</label>
...
<script>
	...
	$('#endtime').timepicker();
	var Raffle_Id = "<?php echo $this->uri->segment(3); ?>";
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    if (json.code == 1)
                    {
                        ...
                        setTimeout(function () {
                            $("#modsuccessMessage").hide();
                            window.location.href = "<?php echo site_url("raffle"); ?>";
                        }, 5000);
                    } else if (json.code == 0)
                    {
