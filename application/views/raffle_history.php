                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> Raffle History
                        </h4>
                    </div>
                </div>
            </div>
										...
										foreach ($raffle_list as $item) {
											...
											<tr>
												...
												<?php if ($item->Start_Date == '0000-00-00 00:00:00' && $item->Start_Date == '0000-00-00 00:00:00') { ?>
													<td><button type="button" class="btn btn-primary " onclick="setid(<?php echo $item->Raffle_Id; ?>)" data-toggle="modal" data-target="#responsive-modal" data-whatever="@mdo">Add</button></td>
												<?php } else { ?>															
													<td><?php
												...
												<td><div class="input-group-btn">
														...
														<ul class="dropdown-menu dropdown-menu-right">                                 
															...
															<li><?php if ($item->Raffle_Status == '0') { ?><a id="del<?php echo $cnt; ?>" class="dropdown-item" onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo site_url("item/delete_data/$item->Item_Id/auction") ?>"><span class="fa fa-trash-o"> &nbsp;    Delete</span></a><?php
																} else {
																	
																}
																?> 
															</li> 
															<li><?php if ($item->Raffle_Status == '1') { ?><a id="view<?php echo $cnt; ?>" class="dropdown-item" href="<?php echo site_url("Raffle/raffle_Winner/$item->Raffle_Id") ?>"><span class="fa fa-eye"> &nbsp;    View</span></a><?php
																} else {
