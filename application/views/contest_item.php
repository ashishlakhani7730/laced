                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> Contest Item
                        </h4>
                    </div>
                </div>
            </div>
										...
										foreach ($contest_list as $item) {
											...
											<tr>
												...
												<?php if ($item->Start_Date == '0000-00-00 00:00:00' && $item->Start_Date == '0000-00-00 00:00:00') { ?>
													<td><a href="<?php echo site_url("Contest/contest_date")."/".$item->Contest_Id; ?>" class="btn btn-primary " >Add</a></td>
												<?php } else { ?>															
													<td><?php
												...
												<td><div class="input-group-btn">
														<button id="action<?php echo $cnt; ?>" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">Action <span class="caret"></span></button>
														<ul class="dropdown-menu dropdown-menu-right">                                 



															<li><?php if ($item->Contest_Status == '0') { ?><a id="del<?php echo $cnt; ?>" class="dropdown-item" onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo site_url("Contest/delete_data/$item->Contest_Id/auction") ?>"><span class="fa fa-trash-o"> &nbsp;    Delete</span></a><?php
																} else {
																	
																}
																?> 
															</li> 
															<li><?php if ($item->Contest_Status == '0') { ?><a id="view<?php echo $cnt; ?>" class="dropdown-item" href="<?php echo site_url("Contest/contest_user/$item->Contest_Id") ?>"><span class="fa fa-eye"> &nbsp;    View</span></a><?php
																} else {
                ...
                success: function (json) {
                    ...
                    if (json.code == 1)
                    {
                        ...
                        setTimeout(function () {
                            ...
                            window.location.href = "<?php echo site_url('contest/index') ?>";
