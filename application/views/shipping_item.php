                                                    ...
                                                    if ($shipping_list) {
                                                        ...
                                                        foreach ($shipping_list as $item) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $item->sellerPhone; ?></td>
                                                                ...
                                                                <td><div class="input-group-btn">
                                                                        <button type="button" class="btn btn-info " onclick="test('<?= @$item->Order_Id ?>')">Verify </button>
                                                        ...
                                                        echo "<tr><td colspan='11'>No any Product Found On Auction</td></tr>";
                                                    }
                                                    ?>            
									</tbody>
									<tfoot>
    ...
    function trackdetail(Tracking_No1)
    {
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                {
                    $("#moremodfMessage1").html('<strong>' + json.message + '</strong>');
                    $("#moremodfailMessage1").show();
                    setTimeout(function () {
                        $("#moremodfailMessage1").hide();
                    }, 8000);
                }
            }
        });
...
<?php } ?>
    ...
    function test(Order_Id)
    {
        var id = Order_Id;
                    ...
                    $.ajax({
                        url: "<?php echo site_url("Shipping/verifyProduct") ?>",
                        type: 'POST',
                        data: {Order_Id: id},
                        //dataType: 'json'
						success: function (json) {
