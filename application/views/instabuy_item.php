                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> Instabuy Product
                        </h4>
                    </div>
                </div>
            </div>
									...
									if ($item_list) {
										...
										foreach ($item_list as $item) {
											...
											<tr>
												...
												<td>
													<?php if ($item->Item_MarketPrice == '') { ?>
														<button type="button" class="btn btn-primary " onclick="setmarketp(<?php echo $item->Item_Id; ?>)" data-toggle="modal" data-target="#responsive-modal" data-whatever="@mdo">Add Price</button>
														<?php
													} else {
											...
											<td><div class="input-group-btn">
													...
													<ul class="dropdown-menu">   
														...
														if ($item->Item_Status == '1') {
															?>
															<li><a onclick="return confirm('Are you sure you want to disapprove this item?');" href="<?php echo site_url("item/app_disapp/$item->Item_Id/$item->User_Id/0/instabuy") ?>"><span class="glyphicon glyphicon-remove" style="color: red"> </span>&nbsp; disapproved</a></li>
															<?php
														}
														?>
														<?php
														if ($item->Item_Status == '0') {
															?>
															<li><a onclick="return confirm('Are you sure you want to approve this item?');" href="<?php echo site_url("item/app_disapp/$item->Item_Id/$item->User_Id/1/instabuy") ?>"><span class="glyphicon glyphicon-ok" style="color: green"> </span>&nbsp; approve</a></li>
															<?php
														}
														?>
														<li><?php if ($item->Item_Status == '1') { ?><a  href="<?php echo site_url("item/raffle_data/$item->Item_Id/instabuy") ?>"> <span class="pe pe-7s-ticket" ></span>   &nbsp;   Raffle</a><?php
															} else {
																
															}
															?> </li>
														<li><?php if ($item->Item_Status == '1') { ?><a  href="<?php echo site_url("item/contest_data/$item->Item_Id/instabuy") ?>"> <span class="pe pe-7s-ticket" ></span>   &nbsp;  Contest</a><?php
															} else {
																
															}
															?> </li>
														<li> <a  onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo site_url("item/delete_data/$item->Item_Id/instabuy") ?>" ><span class="fa fa-trash-o"> &nbsp;    Delete</span></a> </li>
														<!--<li> <a  href="<?php echo site_url("item/viewAllProductImages/$item->Item_Id") ?>" ><span class="fa fa-image"> &nbsp;Transparent </span></a> </li>-->
													</ul>
												</div>  
											</td>
											</tr>
										...
										echo "<tr><td colspan='12'>No any Product Found On Instabuy</td></tr>";
									}
									?>             
									</tbody>
									<tfoot>
