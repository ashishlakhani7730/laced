									...
									<?php
                                                    if ($payment_list) {
                                                        ...
                                                        foreach ($payment_list as $item) {
                                                            ...
                                                            <tr>
                                                                <td><?php echo $cnt++ ?></td>
                                                                <td><img src="<?php echo base_url() ?>./Items/<?php echo $item->sellerProfile ?>" height="50" width="50"></td>
                                                                <td><?php echo $item->seller; ?></td>
                                                                <td><?php echo $item->sellerEmail; ?></td>
                                                                <td><?php echo $item->total; ?></td>
                                                                <td>
                                                                    <button type="button" class="btn btn-primary" > <a  href="<?php echo site_url("Payment/more_detail/$item->suserid") ?>"> More</a></button>
                                                                </td>
                                                                ...
                                                                <td><div class="input-group-btn">
                                                                        ...
                                                                        <ul class="dropdown-menu">                                 
                                                                            ...
                                                                            <li><button type="button" class="form-control"  onclick="test1('<?= @$item->suserid ?>')">Trasfer To Wallet</button></li>
...
<?php } ?>
    ...
    {   
        ...
        suserId = suserid;
		$.ajax({
			url: "<?php echo site_url("Payment/completePayment") ?>",
			type: 'POST',
    ...
    function test1(suserid)
    {      
        suserId = suserid;
                    $.ajax({
                        url: "<?php echo site_url("Payment/add_all_walletBalance") ?>",
                        type: 'POST',
