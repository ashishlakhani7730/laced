										...
										foreach ($item_list as $item) {
											...
											<td><div class="input-group-btn">
													...
													<ul class="dropdown-menu">                                 
														...
														if ($item->Item_Status == '1') {
															?>
															<li><a onclick="return confirm('Are you sure you want to disapprove this item?');" href="<?php echo site_url("item/app_disapp/$item->Item_Id/$item->User_Id/0/trade") ?>"><span class="glyphicon glyphicon-remove" style="color: red"> </span>&nbsp; disapproved</a></li>
															<?php
														}
														?>
														<?php
														if ($item->Item_Status == '0') {
															?>
															<li><a onclick="return confirm('Are you sure you want to approve this item?');" href="<?php echo site_url("item/app_disapp/$item->Item_Id/$item->User_Id/1/trade") ?>"><span class="glyphicon glyphicon-ok" style="color: green"> </span>&nbsp; approve</a></li>
															<?php
														}
														?>
														<li><?php if ($item->Item_Status == '1') { ?><a  href="<?php echo site_url("item/raffle_data/$item->Item_Id/trade") ?>"> <span class="pe pe-7s-ticket" ></span>   &nbsp;   Raffle</a><?php
															} else {
																
															}
															?> </li>
														<li><?php if ($item->Item_Status == '1') { ?><a  href="<?php echo site_url("item/contest_data/$item->Item_Id/trade") ?>"> <span class="pe pe-7s-ticket" ></span>   &nbsp;  Contest</a><?php
															} else {
														...
														<li><?php if ($item->Item_Status == '1') { ?>
															...
															?></li>
														<!--<li> <a  href="<?php echo site_url("item/viewAllTradeProductImages/$item->Item_Id") ?>" ><span class="fa fa-image"> &nbsp;Transparent </span></a> </li>-->
