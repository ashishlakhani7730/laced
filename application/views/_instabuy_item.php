                ...
                <div class="container-fluid">
                    ...
                    <div class="row heading-bg">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h5 class="txt-dark">Instabuy Product</h5>
                        </div>
                        <!-- Breadcrumb -->
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <ol class="breadcrumb">
                                <li><a href="<?php echo base_url() . 'home'; ?>">Dashboard</a></li>
                                <li><a href="#"><span>Instabuy Product List</span></a></li>
                            </ol>
                        </div>
                        <!-- /Breadcrumb -->
                    </div>
                                                        ...
                                                        foreach ($item_list as $item) {
                                                            ...
                                                            <td><div class="input-group-btn">
                                                                    ...
                                                                    <ul class="dropdown-menu">   
                                                                        ...
                                                                        if ($item->Item_Status == '1') {
                                                                            ?>
                                                                            <li><a href="<?php echo site_url("item/app_disapp/$item->Item_Id/$item->User_Id/0/instabuy") ?>"><span class="glyphicon glyphicon-remove" style="color: red"> </span>&nbsp; disapproved</a></li>
                                                                            <?php
                                                                        }
                                                                        ?>
                                                                        <?php
                                                                        if ($item->Item_Status == '0') {
                                                                            ?>
                                                                            <li><a href="<?php echo site_url("item/app_disapp/$item->Item_Id/$item->User_Id/1/instabuy") ?>"><span class="glyphicon glyphicon-ok" style="color: green"> </span>&nbsp; approve</a></li>
                                                                            <?php
                                                                        }
                                                                        ?>
